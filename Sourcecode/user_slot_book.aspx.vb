...
Partial Class vechicle_register
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Dim s As String
        If TextBox7.Text = Session("otp") Then


            s = "insert into vregister (rno,vtype,vname,oname,cno,dt,tm,pid,uid,email) values('" & TextBox1.Text & "','" & DropDownList1.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & TextBox4.Text & "','" & TextBox5.Text & "','" & TextBox6.Text & "','" & Session("id") & "','" & Session("cid") & "','" & Session("email") & "')"
        ...
        Else
            Response.Write("<script LANGUAGE='JavaScript'>alert('Please Check your OTP')</script>")
        End If
    End Sub
End Class
