        ...
        <div class="col-sm-4">
           ...
           <div class="col-sm-4 mb-2">
            ...
            <div class="col-sm-8 mb-2">
                    ...
                    <asp:TextBox ClientIDMode="Static" onkeypress="return pincode1(event)" class="form-control" ID="TextBox4" runat="server" required></asp:TextBox>
            </div>
            <div class="col-sm-4 mb-2">
                <label class="control-label">
                Contact No
            ...
            <div class="col-sm-8 mb-2">
                    ...
                    <asp:TextBox ID="TextBox5" ClientIDMode="Static" onkeypress="return contact1(event)"   class="form-control"  runat="server" required></asp:TextBox>
                </div>
            <div class="col-sm-4 mb-2">
                <label class="control-label">
                E-Mail ID
