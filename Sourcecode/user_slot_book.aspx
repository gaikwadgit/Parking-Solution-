...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-sm-8 mb-2">
			<asp:TextBox required ID="TextBox4" ClientIDMode="Static" onkeypress="return contact1(event)"  CssClass="form-control" runat="server"></asp:TextBox>
			</div>
            <div class="col-sm-4 mb-2">
			Date
			</div>
            ...
            <div class="col-sm-8 mb-2">
			<asp:TextBox required ID="TextBox7" CssClass="form-control" runat="server" ></asp:TextBox>
			</div>
            <div class="col-sm-4 mb-2">
